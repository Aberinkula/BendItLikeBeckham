...
BAKKESMOD_PLUGIN(BendItPlugin, "Bend It Like Beckham  Questions/Bugs?  Go to BakkesMod discord or DM http://twitter.com/FrancesElMute", "1.07", PLUGINTYPE_FREEPLAY | PLUGINTYPE_CUSTOM_TRAINING)
